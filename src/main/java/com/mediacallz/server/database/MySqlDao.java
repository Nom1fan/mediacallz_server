...
import com.mediacallz.server.database.dbos.CallRecordDBO;
...
public class MySqlDao implements Dao {
    ...
    public void initConn() throws SQLException {
        ...
        dbConn = DriverManager.getConnection("jdbc:mysql://" + dbHost + ":" + dbPort + "/sys?" +
    ...
    @Override
    public void insertMediaCallRecord(CallRecordDBO callRecord) throws SQLException {

        String type = callRecord.getSepecialMediaType().toString();
        FileManager visualMediaFile;
        FileManager audioMediaFile;
        String visualMd5 = null;
        String audioMd5 = null;

        if ((visualMediaFile = callRecord.getVisualMediaFile()) != null) {
    ...
    public List<MediaTransferDBO> getAllUserMediaTransferRecords(String uid) throws SQLException {
        ...
        Statement st = null;
        ResultSet resultSet = null;
        List<MediaTransferDBO> records = new LinkedList<MediaTransferDBO>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                records.add(new MediaTransferDBO(
